...
export const createUser = async (userData: { firstName: string; lastName: string; email: string; cohort: string; role: UserRole, accessDurationDays?: number, expirationDate?: string }) => {
